...
function TypeWriterText({ text }: { text: string }) {
  return (
    <motion.span
      ...
      initial="hidden"
      animate="visible"
      className="inline text-primary/70"
    >
...
export default function Home() {
  ...
  const age = getAge(new Date("2007-01-04"));
  ...
  return (
    <div className="relative">
            ...
            <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12">
              ...
              >
                <motion.h1
                  ...
                  className="text-4xl sm:text-5xl md:text-[70px] font-bold tracking-tight text-white leading-[1.2] md:leading-[1.1]"
                >
                  I&apos;m{" "}
                  <span className="text-white text-5xl sm:text-6xl md:text-[72px]">Peacefull</span>, a{" "}
                  <br />
                  <span className="text-primary/90 text-5xl sm:text-6xl md:text-[72px]">{age}</span>
                ...
                >
                  Full-stack Developer &amp; UI Specialist. I turn complex ideas into seamless digital
                ...
                >
                  ...
                  <MotionButton label="Contact Me" href="#contact" />
                </motion.div>
              </motion.div>

              {/* Floating Profile Picture — entrance handled separately from the float loop */}
              <motion.div
              ...
              >
                {/* Inner wrapper handles the infinite float so it doesn't interfere with entrance */}
                <motion.div
                  animate={{ y: [0, -14, 0] }}
                  transition={{
                    repeat: Infinity,
                ...
                >
                  ...
                  <img
                    ...
                    alt="Peacefull Manzi – profile photo"
                    width={288}
                    height={288}
          ...
          <SectionWrapper id="about">
            ...
            <div className="grid md:grid-cols-2 gap-16 text-neutral-400 leading-relaxed font-light text-lg">
              <div className="space-y-8">
                <p>
                  My journey started with a fascination for building things that live on the internet.
                  Fast-forward to today, and I&apos;ve had the privilege of developing premium SaaS
                  products, interactive web applications, and intuitive user interfaces.
                </p>
                <p>
                  My main focus these days is building accessible, inclusive products and digital
                  experiences for a variety of clients. I enjoy the challenge of solving high-level
                  architectural problems while maintaining a pixel-perfect design system.
                </p>
              </div>
              <div className="space-y-12">
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {["React", "Next.js", "TypeScript", "Tailwind CSS", "Framer Motion", "Zustand"].map(
                      (skill) => (
                        <motion.span
                          key={skill}
                          whileHover={{ scale: 1.08, y: -2 }}
                          transition={{ type: "spring", stiffness: 400, damping: 17 }}
                          className="px-5 py-2.5 border border-white/5 rounded-full text-sm bg-white/5 text-neutral-300 hover:text-primary hover:border-primary/30 cursor-default transition-colors duration-300"
                        >
                          {skill}
                        </motion.span>
                      )
      ...
      {/* ============ PROJECTS — full-width horizontal scroll ============ */}
      <HorizontalProjects />

      {/* ============ CONTACT — constrained width ============ */}
      <div className="mx-auto w-[90%] md:w-[80%]">
        <SectionWrapper id="contact" className="pt-0 pb-32">
          <div className="max-w-3xl mx-auto text-center space-y-10 bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-10 md:p-16 shadow-2xl relative overflow-hidden">
            {/* Top accent line */}
            ...
            {/* Primary CTA — single anchor, no nested <a> */}
            <div className="pt-8 flex justify-center">
              <MotionButton
                label="Say Hello"
                href="mailto:peacefullmanzi@gmail.com"
                classes="w-64 h-20 text-2xl"
              />
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-6 md:gap-12 pt-12 border-t border-white/5">
              ...
              <motion.a
                whileHover={{ y: -6 }}
                transition={{ type: "spring", stiffness: 400, damping: 17 }}
                href="https://wa.me/250796348676"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="flex items-center gap-3 text-neutral-500 hover:text-white transition-colors duration-300 group"
              >
                <div className="p-3 bg-white/5 rounded-full group-hover:bg-[#25D366] group-hover:text-white transition-colors duration-300">
              ...
              <motion.a
                whileHover={{ y: -6 }}
                transition={{ type: "spring", stiffness: 400, damping: 17 }}
                href="https://instagram.com/__.peacefull"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <motion.a
                ...
                className="flex items-center gap-3 text-neutral-500 hover:text-white transition-colors duration-300 group"
              >
                <div className="p-3 bg-white/5 rounded-full group-hover:bg-white group-hover:text-black transition-colors duration-300">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <motion.a
                ...
                className="flex items-center gap-3 text-neutral-500 hover:text-white transition-colors duration-300 group"
              >
                <div className="p-3 bg-white/5 rounded-full group-hover:bg-primary group-hover:text-black transition-colors duration-300">
                  <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M1.5 8.67v8.58a3 3 0 003 3h15a3 3 0 003-3V8.67l-8.928 5.493a1.75 1.75 0 01-1.85 0L1.5 8.67zm0-2.324l8.94 5.5a.25.25 0 00.264 0l8.941-5.5A3 3 0 0019.5 3.75h-15a3 3 0 00-3 2.596z" />
                  </svg>
                </div>
